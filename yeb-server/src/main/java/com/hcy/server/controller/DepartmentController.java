...
public class DepartmentController extends ApiController {
     ...
     */
    @GetMapping
    public Object selectAll(Page<DepartmentEntity> page, DepartmentEntity department) {
    ...
    public Object selectByPage(@RequestParam("pageNumber") int pageNumber, @RequestParam("pageSize") int pageSize) {
        Page<DepartmentEntity> page = new Page<>(pageNumber, pageSize);
     ...
     */
    @PostMapping("/insert")
    public Object insert(@RequestBody DepartmentEntity department) {
     ...
     */
    @PutMapping("/update")
    public Object update(@RequestBody DepartmentEntity department) {
